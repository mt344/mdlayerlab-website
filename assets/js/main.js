(function () {
  ...
  var materialsData = [
    ...
    {
      id: 'carbon',
      tab: { de: 'Carbon', en: 'Carbon' },
      name: { de: 'PETG CF (Carbon)', en: 'PETG CF (Carbon)' },
      tagline: { de: 'Carbon-verstärkt & extra steif', en: 'Carbon-reinforced & extra stiff' },
      price: 'ca. 0,45–0,60 €/cm³',
      desc: {
        de: 'Mit Carbonfasern verstärktes PETG – deutlich härter, steifer und formstabiler als normales PETG. Edles, tiefschwarzes Mattfinish mit feiner Carbon-Textur. Ideal für belastbare, technische Teile und hochwertige Deko. Aufgrund von Carbon-Filament und erhöhtem Werkzeugverschleiß etwas teurer.',
        en: 'Carbon-fibre reinforced PETG — noticeably harder, stiffer and more dimensionally stable than standard PETG. A premium deep-black matte finish with a fine carbon texture. Ideal for load-bearing technical parts and high-end decor. Slightly pricier due to the carbon filament and added tool wear.'
      },
      colors: [
        { name: { de: 'Carbon Black', en: 'Carbon Black' }, hex: '#1B1C1E', img: 'petg-cf', desc: { de: 'Tiefschwarzes Mattfinish mit feiner Carbon-Textur – technisch, edel und besonders steif.', en: 'Deep-black matte finish with a fine carbon texture — technical, premium and especially stiff.' } }
      ]
    },
    {
      id: 'tpu',
